<div class="row">
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <input type="text" name="price_sale" spellcheck="false" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{ old('price_sale') }}"" id="price_sale" class="form-control" placeholder="Nhập giá khuyến mãi"> 
