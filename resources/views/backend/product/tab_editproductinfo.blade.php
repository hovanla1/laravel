<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price_buy" spellcheck="false" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="{{ old('price_buy',$product->price_buy) }}" id="price_buy" class="form-control" placeholder="Nhập giá bán"> 
